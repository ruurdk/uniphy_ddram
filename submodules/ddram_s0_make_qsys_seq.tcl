...
lappend arg_list "--component-param=AFI_DATA_WIDTH=576"
lappend arg_list "--component-param=AFI_DATA_MASK_WIDTH=72"
lappend arg_list "--component-param=AFI_DQS_WIDTH=36"
...
lappend arg_list "--component-param=SEQ_ROM=ddram_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=ddram_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=ddram_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=SCC_DATA_WIDTH=9"
...
lappend arg_list "--output-name=ddram_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=STRATIXV"
lappend arg_list "--report-file=sopcinfo:ddram_s0.sopcinfo"
lappend arg_list "--report-file=txt:ddram_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "C:/intelfpga/22.1std/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp

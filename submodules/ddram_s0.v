...
module ddram_s0 (
		...
		output wire [8:0]   phy_read_increment_vfifo_fr, //                 .phy_read_increment_vfifo_fr
		output wire [8:0]   phy_read_increment_vfifo_hr, //                 .phy_read_increment_vfifo_hr
		output wire [8:0]   phy_read_increment_vfifo_qr, //                 .phy_read_increment_vfifo_qr
		...
		output wire [8:0]   phy_read_fifo_reset,         //                 .phy_read_fifo_reset
		output wire [8:0]   phy_vfifo_rd_en_override,    //                 .phy_vfifo_rd_en_override
		input  wire [575:0] phy_read_fifo_q,             //                 .phy_read_fifo_q
		output wire [17:0]  phy_write_fr_cycle_shifts,   //                 .phy_write_fr_cycle_shifts
		...
		output wire [35:0]  afi_dqs_burst,               //                 .afi_dqs_burst
		output wire [3:0]   afi_rst_n,                   //                 .afi_rst_n
		output wire [575:0] afi_wdata,                   //                 .afi_wdata
		output wire [35:0]  afi_wdata_valid,             //                 .afi_wdata_valid
		output wire [71:0]  afi_dm,                      //                 .afi_dm
		output wire [3:0]   afi_rdata_en,                //                 .afi_rdata_en
		output wire [3:0]   afi_rdata_en_full,           //                 .afi_rdata_en_full
		input  wire [575:0] afi_rdata,                   //                 .afi_rdata
		input  wire [3:0]   afi_rdata_valid,             //                 .afi_rdata_valid
		output wire [8:0]   scc_data,                    //              scc.scc_data
		output wire [8:0]   scc_dqs_ena,                 //                 .scc_dqs_ena
		output wire [8:0]   scc_dqs_io_ena,              //                 .scc_dqs_io_ena
		output wire [71:0]  scc_dq_ena,                  //                 .scc_dq_ena
		output wire [8:0]   scc_dm_ena,                  //                 .scc_dm_ena
		input  wire [8:0]   capture_strobe_tracking,     //                 .capture_strobe_tracking
	...
	sequencer_scc_mgr #(
		.AVL_DATA_WIDTH         (32),
		.AVL_ADDR_WIDTH         (13),
		.MEM_IF_READ_DQS_WIDTH  (9),
		.MEM_IF_WRITE_DQS_WIDTH (9),
		.MEM_IF_DQ_WIDTH        (72),
		.MEM_IF_DM_WIDTH        (9),
	...
	rw_manager_ddr3 #(
		...
		.MEM_READ_DQS_WIDTH                   (9),
		.MEM_WRITE_DQS_WIDTH                  (9),
		.AFI_RATIO                            (4),
		.AC_BUS_WIDTH                         (29),
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("STRATIXV"),
		.AC_ROM_INIT_FILE_NAME                ("ddram_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("ddram_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (13312),
		.INIT_FILE        ("ddram_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	ddram_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	ddram_s0_mm_interconnect_1 mm_interconnect_1 (
		.avl_clk_out_clk_clk                             (avl_clk),                                                   //                           avl_clk_out_clk.clk
	...
	ddram_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk

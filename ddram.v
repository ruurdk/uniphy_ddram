...
module ddram (
		...
		output wire [3:0]   local_rdata_error,         //  avl_rdata_error.local_rdata_error
		output wire         ecc_interrupt,             //    ecc_interrupt.ecc_interrupt
	...
	wire   [35:0] m0_phy_mux_afi_wdata_valid;                  // m0:phy_mux_wdata_valid -> p0:afi_wdata_valid
	wire  [575:0] p0_afi_afi_rdata;                            // p0:afi_rdata -> m0:phy_mux_rdata
	wire  [575:0] m0_phy_mux_afi_wdata;                        // m0:phy_mux_wdata -> p0:afi_wdata
	wire    [3:0] m0_phy_mux_afi_rst_n;                        // m0:phy_mux_rst_n -> p0:afi_rst_n
	wire   [35:0] m0_phy_mux_afi_dqs_burst;                    // m0:phy_mux_dqs_burst -> p0:afi_dqs_burst
	...
	wire   [71:0] m0_phy_mux_afi_dm;                           // m0:phy_mux_dm -> p0:afi_dm
	...
	wire  [575:0] m0_afi_afi_rdata;                            // m0:afi_rdata -> c0:afi_rdata
	...
	wire   [71:0] s0_scc_scc_dq_ena;                           // s0:scc_dq_ena -> p0:scc_dq_ena
	wire    [0:0] s0_scc_scc_upd;                              // s0:scc_upd -> p0:scc_upd
	wire    [8:0] s0_scc_scc_dqs_io_ena;                       // s0:scc_dqs_io_ena -> p0:scc_dqs_io_ena
	wire    [8:0] s0_scc_scc_dm_ena;                           // s0:scc_dm_ena -> p0:scc_dm_ena
	wire    [8:0] p0_scc_capture_strobe_tracking;              // p0:capture_strobe_tracking -> s0:capture_strobe_tracking
	wire    [8:0] s0_scc_scc_dqs_ena;                          // s0:scc_dqs_ena -> p0:scc_dqs_ena
	wire    [8:0] s0_scc_scc_data;                             // s0:scc_data -> p0:scc_data
	...
	wire   [35:0] s0_afi_afi_wdata_valid;                      // s0:afi_wdata_valid -> m0:seq_mux_wdata_valid
	wire  [575:0] m0_seq_mux_afi_rdata;                        // m0:seq_mux_rdata -> s0:afi_rdata
	wire  [575:0] s0_afi_afi_wdata;                            // s0:afi_wdata -> m0:seq_mux_wdata
	wire    [3:0] s0_afi_afi_rst_n;                            // s0:afi_rst_n -> m0:seq_mux_rst_n
	wire   [35:0] s0_afi_afi_dqs_burst;                        // s0:afi_dqs_burst -> m0:seq_mux_dqs_burst
	wire   [63:0] s0_afi_afi_addr;                             // s0:afi_addr -> m0:seq_mux_addr
	wire   [11:0] s0_afi_afi_ba;                               // s0:afi_ba -> m0:seq_mux_ba
	wire   [71:0] s0_afi_afi_dm;                               // s0:afi_dm -> m0:seq_mux_dm
	...
	wire    [8:0] s0_phy_phy_read_increment_vfifo_qr;          // s0:phy_read_increment_vfifo_qr -> p0:phy_read_increment_vfifo_qr
	wire    [8:0] s0_phy_phy_vfifo_rd_en_override;             // s0:phy_vfifo_rd_en_override -> p0:phy_vfifo_rd_en_override
	wire    [8:0] s0_phy_phy_read_fifo_reset;                  // s0:phy_read_fifo_reset -> p0:phy_read_fifo_reset
	wire   [17:0] s0_phy_phy_write_fr_cycle_shifts;            // s0:phy_write_fr_cycle_shifts -> p0:phy_write_fr_cycle_shifts
	...
	wire    [8:0] s0_phy_phy_read_increment_vfifo_hr;          // s0:phy_read_increment_vfifo_hr -> p0:phy_read_increment_vfifo_hr
	wire    [8:0] s0_phy_phy_read_increment_vfifo_fr;          // s0:phy_read_increment_vfifo_fr -> p0:phy_read_increment_vfifo_fr
	wire  [575:0] p0_phy_phy_read_fifo_q;                      // p0:phy_read_fifo_q -> s0:phy_read_fifo_q
	...
	wire   [35:0] c0_afi_afi_dqs_burst;                        // c0:afi_dqs_burst -> m0:afi_dqs_burst
	wire   [63:0] c0_afi_afi_addr;                             // c0:afi_addr -> m0:afi_addr
	wire   [71:0] c0_afi_afi_dm;                               // c0:afi_dm -> m0:afi_dm
	...
	wire   [35:0] c0_afi_afi_wdata_valid;                      // c0:afi_wdata_valid -> m0:afi_wdata_valid
	wire  [575:0] c0_afi_afi_wdata;                            // c0:afi_wdata -> m0:afi_wdata
	...
	ddram_c0 c0 (
		...
		.afi_wlat             (m0_afi_afi_wlat),             //                .afi_wlat
		.afi_rlat             (m0_afi_afi_rlat),             //                .afi_rlat
		.ecc_interrupt        (ecc_interrupt),               //   ecc_interrupt.ecc_interrupt
		...
		.local_rdata_error    (local_rdata_error)            // avl_rdata_error.local_rdata_error
	);
